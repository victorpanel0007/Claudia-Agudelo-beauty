        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              className="bg-white rounded-2xl border border-beauty-primary/25 p-6 shadow-card hover:shadow-card-hover transition-all"
            >
              <Quote size={20} className="text-beauty-primary/40 mb-3" />
              <p className="text-beauty-text text-sm leading-relaxed mb-5">&ldquo;{t.text}&rdquo;</p>

              <div className="flex items-center gap-3 pt-4 border-t border-beauty-primary/20">
                ...
                <div>
                  <p className="font-semibold text-beauty-text-dark text-sm">{t.name}</p>
                  <p className="text-beauty-text-muted text-xs">{t.service}</p>
