          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href={`https://wa.me/57${waNumber}?text=Hola`} target="_blank" rel="noopener noreferrer"
                  className="text-beauty-secondary hover:underline text-sm font-medium">
                  +57 {waNumber}
                </a>
            ...
            <div className="flex gap-3 pt-1">
              <a href="https://www.instagram.com/claudiaagudelobeauty" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                className="w-11 h-11 rounded-xl bg-gradient-to-br from-pink-400 to-purple-500 flex items-center justify-center text-white hover:scale-110 transition-transform shadow-sm">
                <Instagram size={18} />
              </a>
              <a href="https://www.facebook.com/share/14d4ZJDy6n8/" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
                className="w-11 h-11 rounded-xl bg-blue-500 flex items-center justify-center text-white hover:scale-110 transition-transform shadow-sm">
                <Facebook size={18} />
              </a>
              <a href="https://www.tiktok.com/@claudiaagudelobeauty0" target="_blank" rel="noopener noreferrer" aria-label="TikTok"
                className="w-11 h-11 rounded-xl bg-black flex items-center justify-center text-white hover:scale-110 transition-transform shadow-sm">
              ...
              <a href={`https://wa.me/57${waNumber}?text=Hola`} target="_blank" rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="w-11 h-11 rounded-xl bg-green-500 flex items-center justify-center text-white hover:scale-110 transition-transform shadow-sm">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
          ...
          <div className="rounded-2xl overflow-hidden border border-beauty-primary/25 shadow-card flex flex-col">
            ...
            <div className="bg-beauty-bg p-4 text-center border-t border-beauty-primary/20">
              <a
                ...
                className="bg-beauty-primary text-white font-semibold px-6 py-2.5 rounded-full text-sm inline-flex items-center gap-2 hover:bg-beauty-primary-dark transition-all"
              >
