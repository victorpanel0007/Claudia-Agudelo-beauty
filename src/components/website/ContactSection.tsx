  ...
  return (
    <section id="contacto" className="py-14 sm:py-20 bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="flex gap-3 pt-1 flex-wrap">
              ...
              <a href={`https://wa.me/57${waNumber}?text=Hola`} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
          ...
          <div className="rounded-2xl overflow-hidden border border-beauty-primary/25 shadow-card flex flex-col">
            <div className="relative w-full bg-beauty-rosa-claro flex flex-col items-center justify-center gap-4 py-12 px-6">
              <div className="w-14 h-14 rounded-full bg-white border border-beauty-primary/20 flex items-center justify-center shadow-sm">
                <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-beauty-primary">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                </svg>
              </div>
              <div className="text-center">
                <h4 className="font-bold text-beauty-text-dark text-base mb-1">¿Lista para tu cita?</h4>
                <p className="text-beauty-text-muted text-sm">Agenda ahora y recibe la dirección<br />exacta de nuestro spa.</p>
              </div>
              <a
                href="https://maps.app.goo.gl/6mw4XkfKPAT8crYS9"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-beauty-primary text-white font-semibold px-6 py-3 rounded-full text-sm inline-flex items-center gap-2 hover:bg-beauty-primary-dark transition-all shadow-sm"
              >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 mt-8">
        <div className="bg-beauty-rosa-claro rounded-2xl px-6 py-4 flex items-center gap-4">
          <div className="w-9 h-9 rounded-full bg-white border border-beauty-primary/20 flex items-center justify-center shrink-0">
            <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-beauty-primary">
              <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
            </svg>
          </div>
          <div>
            <p className="font-semibold text-beauty-text-dark text-sm">Tu bienestar es nuestra prioridad</p>
            <p className="text-beauty-text-muted text-xs">Déjanos consentirte. Te esperamos con los brazos abiertos 💕</p>
          </div>
        </div>
      </div>
    </section>
